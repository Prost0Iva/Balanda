return {
    misc = {
        dictionary = {
            ...
            k_bda_ena = "Благодарю вас за сотрудничество",
            k_bda_ena1 = "ГДЕ, ЧЕРТ ВОЗЬМИ, ЭТОТ БОСС?!",
    ...
    descriptions = {
        ...
        Voucher = {
            ...
            j_bda_ena_red = {
                name = "Ena",
                text = {
                    "{C:mult}+#1#/#2#/#3#{} множ. за",
                    "побеждённый {C:attention}Малый{}/{C:attention}Большой{}/{C:attention}Босс-блайнд",
                    "в этой партии",
                    "Меняет состояние при",
                    "пропуске {C:attention}блайнда{}",
            ...
            j_bda_ena_white = {
                name = "Ena",
                text = {
                    "{C:chips}+#1#/#2#/#3#{} шт. фишек за",
                    "побеждённый {C:attention}Малый{}/{C:attention}Большой{}/{C:attention}Босс-блайнд",
                    "в этой партии",
                    "Меняет состояние при",
                    "пропуске {C:attention}блайнда{}",
                    "{C:inactive}(сейчас {C:chips}+#4#{C:inactive} шт. фишек)",
                },
            },
        },
        Spectral={

...
local test1 = {
    ...
    use = function (self, card, area, copier)
        G.jokers.highlighted[1]:set_keychain('kch_bda_jimbo1')
    end, 
...
local test2 = {
    ...
    use = function (self, card, area, copier)
        G.jokers.highlighted[1]:set_keychain('kch_bda_jimbo2')
    end, 
...
local test3 = {
    ...
    use = function (self, card, area, copier)
        G.jokers.highlighted[1]:set_keychain('kch_bda_jimbo3')
    end, 
...
local test4 = {
    ...
    use = function (self, card, area, copier)
        G.jokers.highlighted[1]:set_keychain('kch_bda_jimbo4')
    end, 
